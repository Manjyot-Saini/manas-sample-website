...
export default (() => {
	return <Theme theme={theme}>
		...
		>
			...
			>
				Our mission is to uphold the tradition of pushing limits of Artificial Intelligence.
			</Text>
		</Section>
		<Section
			...
			>
				...
				>
					<Text
						...
						text-transform="uppercase"
					>
						Team : NILIBHA DAS (TECHNICAL HEAD)  DEEP GUPTA (TEAM MANAGER)  ADITYA BALAJI(R&D HEAD)  AARON JOMY(AI & ROBOTICS HEAD)  TUSHAR UPADHAY (SENSING & AUTOMATION)
					</Text>
					<Text
						md-font="--headline3"
						font="--headline2"
		...
		>
			...
			>
				<Box
					width="100%"
					background="--color-lightD2 url(https://tse1.mm.bing.net/th?id=OIP.0ZWnE_Ac75QiK_FiKGc8VAHaET&pid=Api&P=0) center center/100% no-repeat"
					padding="0px 0px 60% 0px"
					height="0px"
					hover-background="--color-lightD2 url(https://uploads.quarkly.io/5f44d0da669357001e60ed14/images/default-website-illustration-sea-first.svg?v=2020-11-06T16:37:39.391Z) center center/110% no-repeat"
					transition="background --transitionDuration-normal --transitionTimingFunction-easeInOut 0s"
				...
				<Box
					width="100%"
					background="--color-lightD2 url(https://tse1.mm.bing.net/th?id=OIP.LHlPrpcfLBIaEJ8ZoP0ZoAHaEK&pid=Api&P=0) center center/100% no-repeat"
					padding="0px 0px 60% 0px"
					height="0px"
					hover-background="--color-lightD2 url(https://uploads.quarkly.io/5f44d0da669357001e60ed14/images/default-website-illustration-sea-second.svg?v=2020-11-06T17:14:59.136Z) center center/110% no-repeat"
					transition="background --transitionDuration-normal --transitionTimingFunction-easeInOut 0s"
				...
				<Box
					width="100%"
					background="--color-lightD2 url(https://tse2.mm.bing.net/th?id=OIP.DUKAd6UK8u0ci8zb9KayHQHaE8&pid=Api&P=0) center center/100% no-repeat"
					padding="0px 0px 60% 0px"
					height="0px"
					hover-background="--color-lightD2 url(https://uploads.quarkly.io/5f44d0da669357001e60ed14/images/default-website-illustration-sea-third.svg?v=2020-11-06T17:15:50.700Z) center center/110% no-repeat"
					transition="background --transitionDuration-normal --transitionTimingFunction-easeInOut 0s"
				...
				<Box
					height="0px"
					hover-background="--color-lightD2 url(https://tse2.mm.bing.net/th?id=OIP.DUKAd6UK8u0ci8zb9KayHQHaE8&pid=Api&P=0) center center/110% no-repeat"
					transition="background --transitionDuration-normal --transitionTimingFunction-easeInOut 0s"
					width="100%"
				...
				<Box
					width="100%"
					background="--color-lightD2 url(https://tse1.mm.bing.net/th?id=OIP.969vxsKMKJpdl9ZAT2RwpAAAAA&pid=Api&P=0) center center/100% no-repeat"
					padding="0px 0px 60% 0px"
					height="0px"
			...
			>
				<Box>
					<Text
						...
						color="--dark"
					>
						When do the Project MANAS' recruitments commence?
					</Text>
					<Text
						text-align="center"
						margin="16px 0px 0px 0px"
				...
				<Box>
					...
					<Text
						...
						sm-margin="8px 0px 0px 0px"
					>
						Once a candidate has cleared the interview round, they enter the taskphase where the individual learns the essential skills to mak
					</Text>
				</Box>
				<Box>
					<Text
					...
					<Text
						...
						opacity="0.6"
					>
						Handling academics along with student project work is manageable as far as one has the right time management skills.
					</Text>
				</Box>
			</Box>
		</Section>
		...
		>
			...
			>
				...
				<Button
					...
					md-font="--base"
				>
					Building an autonomous car for India. Developed a fully drone.
				</Button>
			</Box>
		</Section>
		<Section
